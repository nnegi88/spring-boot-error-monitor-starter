...
/**
 * Teams-specific implementation of NotificationConfig.
 * Follows interface segregation principle by only implementing required methods.
 */
public class TeamsConfig implements NotificationConfig {
    ...
    public TeamsConfig(String webhookUrl, String applicationName, String environment, 
    ...
    public static class Builder {
        ...
        public TeamsConfig build() {
            return new TeamsConfig(webhookUrl, applicationName, environment, 
