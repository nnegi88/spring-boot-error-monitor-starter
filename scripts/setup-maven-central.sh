...
echo ""
echo "📋 Next Steps:"
echo "1. Create an account at https://central.sonatype.com"
echo "   - Sign up with your GitHub account (recommended)"
echo "   - This automatically verifies ownership of io.github.nnegi88"
echo ""
echo "2. Add your namespace:"
echo "   - Go to your account dashboard"
echo "   - Add namespace: io.github.nnegi88"
echo "   - Verification is automatic since you own the GitHub account"
echo ""
echo "3. Generate User Token:"
echo "   - Go to Account → User Token"
echo "   - Generate a new token for deployment"
echo "   - Use this token (not password) for OSSRH_TOKEN"
echo ""
echo "4. Update GitHub secrets with your token:"
echo "   gh secret set OSSRH_USERNAME --body 'your-username'"
echo "   gh secret set OSSRH_TOKEN --body 'your-token'"
echo ""
echo "5. Once done, trigger the release workflow:"
